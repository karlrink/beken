...
func main() {
	if len(os.Args) < 4 {
		fmt.Println("Usage: " + os.Args[0] + " name aes.key localhost:9480")
		return
	}
...
func encryptAES(plaintext, keyStr string) (string, string, string, error) {
	...
	return ciphertextBase64, nonceBase64, tagBase64, nil
}
